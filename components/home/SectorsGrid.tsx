...
const sectors = [
  {
    ...
    icon: (
      <svg viewBox="0 0 32 32" fill="none" style={{ width: 28, height: 28 }}>
        <rect x="4" y="8" width="24" height="18" stroke="currentColor" strokeWidth="1"/>
        <path d="M10 8V6h12v2M16 12v8M12 16h8" stroke="currentColor" strokeWidth="1"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 32 32" fill="none" style={{ width: 28, height: 28 }}>
        <rect x="6" y="10" width="20" height="16" stroke="currentColor" strokeWidth="1"/>
        <path d="M10 10V7h12v3M10 18h12" stroke="currentColor" strokeWidth="1"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 32 32" fill="none" style={{ width: 28, height: 28 }}>
        <rect x="4" y="6" width="24" height="20" stroke="currentColor" strokeWidth="1"/>
        <path d="M4 14h24M12 6v20M20 6v20" stroke="currentColor" strokeWidth="0.8"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 32 32" fill="none" style={{ width: 28, height: 28 }}>
        <path d="M16 4L28 12v16H4V12L16 4z" stroke="currentColor" strokeWidth="1"/>
        <rect x="12" y="18" width="8" height="10" stroke="currentColor" strokeWidth="1"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 32 32" fill="none" style={{ width: 28, height: 28 }}>
        ...
        <path d="M16 6v4M16 22v4M6 16h4M22 16h4" stroke="currentColor" strokeWidth="0.8"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 32 32" fill="none" style={{ width: 28, height: 28 }}>
        <path d="M4 24L12 14l6 6 4-8 6 4" stroke="currentColor" strokeWidth="1"/>
    ...
    <section style={{
      ...
      <AnimatedSection>
        ...
        <h2 style={{
          ...
          <em style={{ fontStyle: 'italic', color: 'var(--color-gold-light)' }}>Every Major Sector</em>
        </h2>
        <p style={{
          fontFamily: 'var(--font-body)',
          fontSize:   '15px',
