...
export const panels: ServicePanelData[] = [
  ...
  },
  {
    ...
    description: 'Comprehensive legal counsel for businesses operating in Ghana — from employment and commercial contracts to litigation, conveyancing, and regulatory advisory.',
    items: [
      'Labour law advisory',
